...
const EarRing = () => {
  ...
  // Fetch earrings on component mount
  useEffect(() => {
    fetchProductsByCategory('earrings');
  }, [fetchProductsByCategory]);
  ...
  if (error) {
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          <p className="text-red-600 mb-4">Error loading earrings: {error}</p>
          <button
            onClick={() => fetchProductsByCategory('earrings')}
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-white shadow-sm border-b">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-900">Earrings Collection</h1>
          <p className="text-gray-600 mt-2">Discover our stunning collection of elegant earrings</p>
        </div>
      </div>
        ...
        <div className="lg:ml-auto lg:w-3/4">
          ...
          {earringProducts.length === 0 && (
            <div className="text-center py-12">
              <p className="text-gray-500 text-lg">No earrings found matching your filters.</p>
              <button
                onClick={handleClearFilters}
